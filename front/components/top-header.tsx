...
export function TopHeader({ title, subtitle, onCreateTask, onNotificationsClick, currentUser, onLogout }: TopHeaderProps) {
  return (
    <header className="flex h-14 items-center justify-between border-b border-border bg-card px-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Notifications */}
        <Button variant="ghost" size="icon" className="relative size-8 text-muted-foreground hover:text-foreground" onClick={onNotificationsClick}>
